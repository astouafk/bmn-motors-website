...
//           type: 'string',
//           options: {
//             list: ['Pétrole', 'Diesel', 'Hybride', 'Électrique', 'Essence'],
//           },
//         },
//         {
//             name: 'seats',
...
export const vehicleType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      title: 'Prix par jour (FCFA)',
      type: 'number',
      description: 'Laisser vide si le véhicule n\'est pas disponible à la location',
      validation: (Rule) => Rule.min(0), // ✅ Plus de .required()
    }),
    defineField({
      name: 'securityDeposit',
      title: 'Caution (FCFA)',

...
export function HeroSection() {
  return (
    <section className="relative h-screen flex items-center overflow-hidden bg-[var(--color-charcoal)]">
      {/* Background Video from Cloudinary with Overlay */}
      <div className="absolute inset-0">
        <iframe
          src="https://player.cloudinary.com/embed/?cloud_name=dbxgg8ze3&public_id=hero-car_1_zt0yk8&fluid=true&controls=false&autoplay=true&loop=true&muted=true&colors[base]=%23000000&hideContextMenu=true"

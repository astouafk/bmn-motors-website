...
//                   // className="w-full h-[400px] sm:h-[500px] md:h-[600px] lg:h-[700px] object-contain bg-gradient-to-b from-[var(--color-charcoal)]/50 to-[var(--color-charcoal)] ..."
//                 />
...
import { ChevronLeft, ChevronRight } from "lucide-react"
import { getFeaturedVehicles, formatPrice } from "@/lib/data"
import { VehicleShowcaseClient } from "./vehicle-showcase-client"
...
export async function VehicleShowcase() {
  ...
  return <VehicleShowcaseClient vehicles={vehicles} />
}
...
//                 <a href="tel:+221XXXXXXXXX" className="text-[var(--color-gray-200)] text-sm hover:text-[var(--color-orange)] transition-colors">
//                   +221 77 588 99 76
//                 </a>
//               </li>
//               <li className="flex items-center gap-3">
//                 <Mail size={16} className="text-[var(--color-orange)] flex-shrink-0" />
//                 <a href="mailto:contact@bmn-motors.com" className="text-[var(--color-gray-200)] text-sm hover:text-[var(--color-orange)] transition-colors">
...
//             © {new Date().getFullYear()} B-M-N Motors. Tous droits réservés.
//           </p>
//         </div>
//       </div>
//     </footer>

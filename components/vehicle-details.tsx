...
//       `Bonjour! Je suis intéressé(e) par la location du ${vehicle.name} (${vehicle.year}). Pouvez-vous me fournir plus de détails?`,
//     )
...
//                   }`}
//                 >
//                   {vehicle.available ? "Disponible Maintenant" : "Actuellement Indisponible"}
//                 </span>
//               </div>
//             </div>
...
//                 {vehicle.pricePerDay.toLocaleString()} <span className="text-xl">FCFA</span>
//               </p>
//               <p className="text-sm text-[var(--color-cream)]/60 mt-4">
//                 Caution : {vehicle.securityDeposit.toLocaleString()} FCFA
//               </p>
//             </div>
...
//                   <p className="font-semibold text-[var(--color-cream)]">{vehicle.transmission}</p>
//                 </div>
//                 <div className="p-4 bg-[var(--color-gray-900)] rounded-xl">
//                   <p className="text-sm text-[var(--color-cream)]/60 mb-1">Carburant</p>
//                   <p className="font-semibold text-[var(--color-cream)]">{vehicle.fuel}</p>
//                 </div>
//                 <div className="p-4 bg-[var(--color-gray-900)] rounded-xl">
//                   <p className="text-sm text-[var(--color-cream)]/60 mb-1">Places</p>
//                   <p className="font-semibold text-[var(--color-cream)]">{vehicle.seats}</p>
//                 </div>
...
//                   <p className="font-semibold text-[var(--color-cream)]">{vehicle.fuelConsumption}</p>
//                 </div>
//               </div>
//             </div>

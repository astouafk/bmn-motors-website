...
import { getReviewsSchema, getOwnerSchema, getOrganizationSchema } from "@/lib/schema"

import type { Metadata } from "next"

export const metadata: Metadata = {
  title: "B-M-N Motors : 5 Ans d'Excellence en Location Automobile | Dakar",
  description: "Depuis 2021, B-M-N Motors est votre partenaire de confiance pour la location et vente de voitures premium à Dakar. 99% de satisfaction client. 50+ véhicules disponibles.",
  keywords: "bmn motors dakar, location voiture confiance dakar, service premium senegal, experience bmn motors",
  openGraph: {
    title: "B-M-N Motors : 5 Ans d'Excellence",
    description: "99% de satisfaction client. 50+ véhicules premium. Service 24/7.",
    url: "https://www.bmn-motors.com/notre-experience",
    siteName: "B-M-N Motors",
    images: [
      {
        url: "https://www.bmn-motors.com/luxury-car-dealership-showroom-interior.jpg",
        width: 1200,
        height: 630,
      },
    ],
...
export default function ExperiencePage() {
  ...
  const stats = getStats()
    ...
    // Schemas
    const reviewsSchemas = getReviewsSchema()
    const ownerSchema = getOwnerSchema()
